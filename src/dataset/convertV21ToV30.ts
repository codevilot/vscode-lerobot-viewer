...
import { buildDataPath, buildVideoPath, exists, readJsonlIfExists } from "./adapters/util";
import { buildParquetSchema } from "./parquetSchema";
import { floatifyArraysInJson } from "./statsJson";
...
export async function convertV21ToV30(
  ...
  const dataBoundaries = await buildDataShards(sourceRoot, targetRoot, adapter, info, sorted, onProgress);
